...
<div class="accordion" fillSpace="sidebar">
	<shiro:hasPermission name="user">
		...
		<div class="accordionContent">
			<ul class="tree treeFolder">
				...
				<!-- 		<shiro:hasPermission name="ssadmin/subscriptionLogUserList.html">
				<li><a href="ssadmin/subscriptionLogUserList.html" target="navTab"
						rel="subscriptionLogUserList">会员众筹记录列表</a>
					</li>
				</shiro:hasPermission> -->
		...
		<div class="accordionContent">
			<ul class="tree treeFolder">
				...
				<shiro:hasPermission name="ssadmin/transportlogList.html">
					...
					<li><a href="ssadmin/apinameList.html" target="navTab"
						rel="apinameList">应用列表</a>
					</li>
					<li><a href="ssadmin/apitransferList.html" target="navTab"
						rel="apitransferList">转入/转出记录列表</a>
					</li>	
				</shiro:hasPermission>
			</ul>
		</div>
	...
	<shiro:hasPermission name="shop">
		...
		<div class="accordionContent">
			<ul class="tree treeFolder">
				<shiro:hasPermission name="ssadmin/goodsaddressList.html">
					<li><a href="ssadmin/goodsaddressList.html" target="navTab"
						rel="goodsaddressList">会员收货地址列表</a>
					</li>
				</shiro:hasPermission>
				<shiro:hasPermission name="ssadmin/goodsList.html">
					<li><a href="ssadmin/goodsList.html" target="navTab"
						rel="goodsList">正常商品列表</a>
					</li>
				</shiro:hasPermission>
				<shiro:hasPermission name="ssadmin/goodsList1.html">
					<li><a href="ssadmin/goodsList1.html" target="navTab"
						rel="goodsList1">下架商品列表</a>
					</li>
				</shiro:hasPermission>
				<shiro:hasPermission name="ssadmin/goodsList1.html">
					<li><a href="ssadmin/goodtypeList.html" target="navTab"
						rel="goodsList">商品类型列表</a>
					</li>
				</shiro:hasPermission>
