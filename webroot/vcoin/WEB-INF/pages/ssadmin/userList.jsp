		...
		<div class="searchBar">
			...
			<table class="searchContent">
				<tr>
					...
					<td>推荐人中心号：<input type="text" name="troNo" value="${troNo}"
						size="10" />
					</td>
...
<div class="pageContent">
	<div class="panelBar">
		...
		<shiro:hasPermission name="ssadmin/userForbbin7.html">
			...
			<li><a class="edit"
					href="ssadmin/goUserJSP.html?uid={sid_user}&url=ssadmin/userNo"
					target="dialog" rel="userNo" height="300" width="800"><span>设置服务中心</span>
				</a></li>
			<li><a class="edit"
					href="ssadmin/goUserJSP.html?uid={sid_user}&url=ssadmin/proxyNo"
					target="dialog" rel="proxyNo" height="300" width="800"><span>设置省市县</span>
				</a></li>	
			<li><a class="edit"
	...
	<table class="table" width="150%" layoutH="138">
		<thead>
			<tr>
				...
				<th width="40" orderField="fintrolUserNo"
					<c:if test='${param.orderField == "fintrolUserNo" }'> class="${param.orderDirection}"  </c:if>>推荐人服务中心号</th>	
				...
				<th width="60">手机号码</th>
				<th width="60">用户类型</th>
				<th width="60">服务中心号</th>
				<th width="60">手续费奖励比例</th>
				<th width="60">申购奖励比例</th>
				<th width="60">省市县号</th>
				<th width="60">手续费奖励比例</th>
				<th width="60">申购奖励比例</th>
		...
		<tbody>
			<c:forEach items="${userList}" var="user" varStatus="num">
				<tr target="sid_user" rel="${user.fid}">
					...
					<td>${user.fuserType_s}</td>
					<td>${user.fuserNo}</td>
					<td>${user.fServiceTradeRate}</td>
					<td>${user.fServiceSubRate}</td>
					<td>${user.fProxyNumber}</td>
					<td>${user.fProxyTradeRate}</td>
					<td>${user.fProxySubRate}</td>
