		...
		<tbody>
			<c:forEach items="${autotradeList}" var="autotrade"
				...
				<tr target="sid_user" rel="${autotrade.fid}">
					...
					<td><fmt:formatNumber value="${autotrade.fminqty}" pattern="##.######" maxIntegerDigits="15" maxFractionDigits="6"/></td>
					<td><fmt:formatNumber value="${autotrade.fmaxqty}" pattern="##.######" maxIntegerDigits="15" maxFractionDigits="6"/></td>
					<td><fmt:formatNumber value="${autotrade.fminprice}" pattern="##.######" maxIntegerDigits="15" maxFractionDigits="6"/></td>
					<td><fmt:formatNumber value="${autotrade.fmaxprice}" pattern="##.######" maxIntegerDigits="15" maxFractionDigits="6"/></td>
