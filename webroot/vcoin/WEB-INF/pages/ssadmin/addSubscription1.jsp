	...
	<form method="post" action="ssadmin/saveSubscription1.html"
		...
		<div class="pageFormContent nowrap" layoutH="97">
			...
			<dl>
				<dt>支付比例1：</dt>
				<dd>
					<input type="text" name="fcoinRate1" class="required number" />
					<span>小数,不用填0</span>
				</dd>
			</dl>
			<dl>
				<dt>币的价格1：</dt>
				<dd>
					<input type="text" name="fcoinPrice1" class="required number" />
			...
			<dl>
				<dt>支付比例2：</dt>
				<dd>
					<input type="text" name="fcoinRate2" class="required number" />
					<span>小数,不用填0</span>
				</dd>
			</dl>
			<dl>
				<dt>币的价格2：</dt>
				<dd>
					<input type="text" name="fcoinPrice2" class="required number" />
					<span>人民币填1,虚拟币按价格填价格，按数量填0</span>
				</dd>
			</dl>
			<dl>
