		...
		<tbody>
			<c:forEach items="${balanceearningList}" var="balanceearningList" varStatus="num">
				<tr target="sid_user" rel="${balanceearningList.fid}">
					...
					<td><fmt:formatNumber value="${balanceearningList.fbalanceqty}" pattern="##.##" maxIntegerDigits="15" maxFractionDigits="6"/></td>
					<td><fmt:formatNumber value="${balanceearningList.freceiveqty}" pattern="##.##" maxIntegerDigits="15" maxFractionDigits="6"/></td>
