...
<div class="pageContent">
	...
	<table class="table" width="150%" layoutH="138">
		<thead>
			<tr>
				<th width="20">序号</th>
				<th width="30">付款类型1</th>
				<th width="30">支付比例1</th>
				<th width="30">币价格1</th>
				<th width="30">币1是否奖励</th>
				<th width="30">付款类型2</th>
				<th width="30">支付比例2</th>
				<th width="30">币价格2</th>
				<th width="30">币2是否奖励</th>
				<th width="30">解冻类型</th>
				<th width="30">解冻比例</th>
		...
		<tbody>
			<c:forEach items="${subscriptionList1}" var="subscription"
				...
				<tr target="sid_user" rel="${subscription.fid}">
					...
					<td>${subscription.fcoinRate1}</td>
					<td>${subscription.fcoinPrice1}</td>
					<td>${subscription.fiscoin1}</td>
					<td>${subscription.symbol_2}</td>
					<td>${subscription.fcoinRate2}</td>
					<td>${subscription.fcoinPrice2}</td>
					<td>${subscription.fiscoin2}</td>
