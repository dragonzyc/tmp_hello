			...
			<c:forEach items="${subscriptionLogList}" var="subscriptionLog"
				...
				<tr target="sid_user" rel="${subscriptionLog.fid}">
				   <td><input name="ids" value="${subscriptionLog.fid}"
					...
					<td>
					<c:if test="${subscriptionLog.fsubscription.fcoinRate1 >0 }">
					${subscriptionLog.fsubscription.symbol1}${subscriptionLog.fprice}
					</c:if>
					<c:if test="${subscriptionLog.fsubscription.fcoinRate2 >0 }">
					<c:if test="${subscriptionLog.fsubscription.fcoinRate1 >0 }">+</c:if>
					${subscriptionLog.fsubscription.symbol1_2}${subscriptionLog.fprice2}
					</c:if>
					</td>
					<td>${subscriptionLog.fsubscription.symbol1}${subscriptionLog.ftotalCost}</td>
					<td>${subscriptionLog.fsubscription.symbol1_2}${subscriptionLog.ftotalCost2}</td>
