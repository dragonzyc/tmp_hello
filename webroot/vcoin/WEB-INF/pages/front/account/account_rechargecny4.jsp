								...
								<div class="col-xs-12 padding-clear padding-top-30">
									<div id="rechage1" class="col-xs-7 padding-clear form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-xs-7">
												<input id="accounts" class="form-control" type="text">
											</div>
										</div>
										<div class="form-group">
											<label for="sbank" class="col-xs-3 control-label">验证码</label>
											<div class="col-xs-7">
												<input id="imgcode" class="form-control" type="text">
												<img class="btn btn-imgcode" src="/servlet/ValidateImageServlet?r=<%=new java.util.Date().getTime() %>"></img>
											</div>
										</div>
										<div class="form-group">
											<label for="sbank" class="col-xs-3 control-label"></label>
											<div class="col-xs-7">
												<span class="control-label text-left text-danger rechage-tips margin-bottom-clear"> 注意：转账时转账说明必须填写 ${fuser.fid } </span>
											</div>
										</div>
										<div class="form-group">
											<label for="sbank" class="col-xs-3 control-label"></label>
											<div class="col-xs-7">
												<span class="wechatqrcodetxt">
													<img class="wechatqrcode" alt="" src="${requestScope.constant['wxImages'] }">
													<i>扫描二维码</br>加好友转账</i>
												</span>
											</div>
										</div>
