...
<div class="col-xs-2 leftmenu">
	<ul class="nav nav-pills nav-stacked">
		...
		<li class=""><a href="/user/apilogs.html">API交易记录 </a></li>
...
<div class="col-xs-2 leftmenu">
	<ul class="nav nav-pills nav-stacked">
		...
		<li class="">
			<a href="/account/rechargeCny.html"> C2C </a>
		</li>
		<li class="">
			<a href="/account/withdrawCny.html"> 提现 </a>
		</li>
		<!-- <li class="">
			<a href="/crowd/logs.html"> 我的众筹 </a>
		</li> -->
		<li class="">
			<a href="/divide/myGivenCNY.html"> 我的分红</a>
		</li>
        <li class="">
			<a href="/account/btcTransport.html"> 会员转账</a>
		</li>
		<li class="">
			<a href="/exchange/index.html" > 兑换中心</a>
		</li>
		<li class="">
		...
		<li class="">
			<a href="/introl/mydivide.html"> 推广明细 </a>
		</li>
		<li class="">
		...
		<span class="leftmenu-title top">
			<i class="lefticon shop"></i>
			商城管理
		</span>
		<li class=""><a href="/shop/address.html"> 收货地址 </a>
		</li>
		<li class=""><a href="/shop/myorder.html"> 我的订单 </a>
		</li>
	</ul>
</div>
	...
	<ul class="nav nav-pills nav-stacked ">
		...
		<c:forEach var="v" varStatus="vs" items="${ftrademappings }">
			<span class="leftmenu-title leftmenu-folding top"
					...
					${v.fvirtualcointypeByFvirtualcointype2.fname }(${v.fvirtualcointypeByFvirtualcointype1.fShortName })交易 </span>
				...
				<li class=" trademenu${v.fid }" style="display:${ftrademapping.fid!=v.fid?'none':''}"><a
					href="/about/index.html?id=${v.fvirtualcointypeByFvirtualcointype2.fweburl }"> ${v.fvirtualcointypeByFvirtualcointype2.fname }介绍</a></li>	
		</c:forEach>
	</ul>
</div>
