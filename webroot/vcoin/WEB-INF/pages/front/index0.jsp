...
<%@include file="comm/header.jsp"%>
	...
	<div class="container-full ">
		<div class="container login-box">
			...
			<p style=" font-size:12px; line-height:22px;">数字货币交易具有极高的风险（预挖、暴涨暴跌、庄家操控、团队解散、技术缺陷等），据国家五部委《关于防范比特币风险的通知》，金海贝数字资产交易平台仅为数字货币的爱好者提供一个自由的网上交换平台，对币的投资价值不承担任何审查、担保、赔偿的责任，如果您不能接受，请不要进行交易！谢谢！</p>
		</div>
						</div>
						<div class="form-group">
		...
		<div class="modal-dialog" role="document">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<span class="modal-title" id="exampleModalLabel" style="font-size: 20px;">尊敬的金海贝数字资产交易平台用户：</span>
				</div>
				<div class="modal-body">
				<div class="paragraph paragraph_news" style="font-size:14px;text-indent:2em;line-height: 30px;text-align:left;">   近期受整体环境影响，在金海贝数字资产交易平台进行交易的数字资产短期累计涨幅都已非常巨大，各类数字资产交易风险已急剧增大，金海贝币币交易平台已多次提醒请广大投资者要切实做好风险防范工作，要充分提高风险意识，要特别谨慎地进行交易。</div> 
				<div class="paragraph paragraph_news" style="font-size:14px;text-indent:2em;line-height: 30px;text-align:left;padding:0 20px">金海贝数字资产交易平台提醒您：不投入超过风险承受能力的资金，不投资不了解的数字资产，不听信任何以金海贝数字资产交易平台名义推荐买币投资的宣传，坚决抵制传销、电信诈骗和洗钱套汇等违法行为。</div>
				</div>
