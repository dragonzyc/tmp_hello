				...
				<div class="col-xs-12 padding-right-clear padding-left-clear rightarea user">
					<div class="col-xs-12 rightarea-con">
						<ul class="nav nav-tabs rightarea-tabs">
							<li class="active"><a href="/divide/myGivenCNY.html">分红人民币</a>
							</li>
							...
							<table class="table table-striped">
								<tr class="bg-gary">
									...
									<tr>
										...
										<td>￥<fmt:formatNumber value="${v.fshareplan.famount }" pattern="##.##" maxIntegerDigits="15" maxFractionDigits="6"/></td>
										...
										<td>￥<fmt:formatNumber value="${v.famount }" pattern="##.##" maxIntegerDigits="15" maxFractionDigits="6"/></td>
										<td>${v.fstatus_s }
