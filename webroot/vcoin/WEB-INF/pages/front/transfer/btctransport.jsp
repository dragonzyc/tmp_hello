					...
					<div class="col-xs-12 rightarea-con">
						...
						<div class="col-xs-12 padding-clear padding-top-30">
							<div class="col-xs-7 padding-clear form-horizontal">
								...
								<div class="form-group ">
									<label for="diyMoney" class="col-xs-3 control-label">虚拟币类型</label>
									<div class="col-xs-6">
							...
							<div class="col-xs-5" style="padding:80px 60px;">
								<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=204594110&site=qq&menu=yes">
									<img border="0" src="http://wpa.qq.com/pa?p=2:204594110:53" alt="联系客服" title="联系客服" style="margin-left:40px;"/>
								</a>
								<p style="margin-top:20px;">转账如10分钟未到达，请联系客服</p>
							</div>
												...
												<c:forEach items="${list }" var="v" varStatus="vs">
													<tr>
													    ...
													    <td><fmt:formatNumber
																	...
																	maxIntegerDigits="15" maxFractionDigits="6" /></td>
														<td><fmt:formatNumber
													    ...
													    &nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:cancelTransport(${v.fid });" class="opa-link">撤消</a>
													    </c:if>
													    </td>
													</tr>
												</c:forEach>
...
<%@include file="../comm/footer.jsp" %>	
	...
	<script type="text/javascript" src="${oss_url}/static/front/js/transfer/transfer.js"></script>
</body>
</html>
