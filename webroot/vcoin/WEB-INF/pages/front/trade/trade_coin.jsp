	...
	<div class="container-full padding-top-30">
		<div class="container displayFlex">
			...
			<div class="col-xs-10 padding-right-clear">
               ...
               <div class="all_coin_info_up">
				<dl class="all_coin_info">
					<div id="marketLastPoint" style="padding-left: 5px;">
						<span class="trade-depth1"> ${coin2.fname }(${coin1.fShortName })最新价： <span class=""> <span
								id="lastprice"> </span> <span id="lastpriceicon" class="arrow-icon-big red"></span></span></span>
					</div>
				...
				<div class="col-xs-12 rightarea-con padding-right-clear padding-left-clear">
							...
							<div class="max-width clearfix" id="buypricediv">
								<div class="col-xs-6">
									<div class="form-group">
										...
										<input id="tradebuyprice" class="form-control" type="text" value="${recommendPrizebuy }">
									</div>
									<!-- <div class="form-group">
								...
								<div class="col-xs-6">
									<div class="form-group">
										...
										<input id="tradebuyamount" class="form-control" type="text" value="">
									</div>
									<div class="form-group">
							...
							<div class="max-width clearfix" id="sellpricediv">
								<div class="col-xs-6">
									<div class="form-group">
										...
										<input id="tradesellprice" class="form-control" type="text" value="${recommendPrizesell }">
									</div>
									<div class="form-group">
								...
								<div class="col-xs-6">
									<div class="form-group">
										...
										<input id="tradesellamount" class="form-control" type="text" value="">
									</div>
									<div class="form-group">
										<span class="form-control trade-tips">
											<span class="col-xs-5 text-left padding-right-clear">交易额</span>
					...
					<!-- <span class="trade-depth">
							<span class="col-xs-2 padding-clear" style="width:20%;">买卖</span>
							<span class="col-xs-5 text-right padding-clear" style="width:40%;">价格</span>
							<span class="col-xs-5 text-right padding-clear" style="width:40%;">数量</span>
