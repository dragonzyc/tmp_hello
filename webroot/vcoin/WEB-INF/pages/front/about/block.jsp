...
<div class="container-fluid">
    <div class="col-md-4 col-sm-6 l_pic">
        <div class="l_pic_icon"><img src="${oss_url}/static/front/images/activity/jijin_06.jpg"></div>
       <div class="l_pic_tit"><br></div>
    </div>
    <div class="col-md-4 col-sm-6 l_pic">
        <div class="l_pic_icon"><img src="${oss_url}/static/front/images/activity/jijin_07.jpg"></div>
       <div class="l_pic_tit"><br></div>
    </div>
    <div class="col-md-4 col-sm-6 l_pic">
        <div class="l_pic_icon"><img src="${oss_url}/static/front/images/activity/jijin_09.jpg"></div>
       <div class="l_pic_tit"><br></div>
    </div>
</div>
...
<script type="text/javascript" src="${oss_url}/static/front/js/jquery.touchSlider.js"></script>
