						...
						<div class="col-xs-12 padding-clear">
							...
							<div class="con-items">
										...
										<div class="title">
											...
											<a class="text-link" href="javascript:void(0)" data-toggle="modal" data-target="#unbindgoogle">查看&gt;&gt;</a>
											</c:when>
											<c:otherwise>
										...
										<div class="content">
											...
											<div class="content-rt">
												<p class="icon-${isBindGoogle == false?'no':'ok' }">${isBindGoogle == false?'未绑定':'已绑定' }</p>
