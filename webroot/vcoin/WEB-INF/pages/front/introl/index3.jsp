				...
				<div class="col-xs-12 padding-right-clear padding-left-clear rightarea user">
					<div class="col-xs-12 rightarea-con">
						<ul class="nav nav-tabs rightarea-tabs">
							<li class="">
								<a href="/introl/mydivide.html?type=1">会员推广明细</a>
							</li>
							<li class="active">
								<a href="javascript:void(0)">服务中心推广明细</a>
							</li>
							<li>
						...
						<div class="col-xs-12 padding-clear padding-top-30 padding-bottom-30">
								<div class="panel panel-tips">
									...
									<div class="panel-body">
									    ...
									    &lt
									           您的专属推广地址
									    <input value="${spreadLink }" readonly="" type="text" style="width: 335px;height: 30px;color: red;background-color: #ffffff;background-image: none;border: 1px solid #cccccc;"/>
									    </p>
									</div>
								</div>
							</div>
